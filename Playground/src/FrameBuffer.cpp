...
bool FrameBuffer::AttachColorBuffer(std::shared_ptr<OpenGLTexture> colorbuf)
{
	Bind();
	glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, colorbuf->GetId(), 0);
	Unbind();
	return true;
}
