...
int main(int, char**) {
  ...
  // oversampling) and
  //  stored
  // into a texture when calling
  // ImFontAtlas::Build()/GetTexDataAsXXXX(),
  //    which
  // ImGui_ImplXXXX_NewFrame below will call.
  // - Use '#define IMGUI_ENABLE_FREETYPE' in your
  // imconfig file to use
  //      Freetype
  // for higher quality font rendering.
  // - Read 'docs/FONTS.md' for more
  // instructions and details.
  // - Remember that in C/C++ if you want to
  // include a backslash \ in a
  // string
  // literal you need to write a
  // double backslash \\ !
  // - Our Emscripten build process
  // allows embedding fonts to be
  // accessible
  // at
  // runtime from the
  // "fonts/" folder. See
  // Makefile.emscripten for
  // details.
